...
const featuredCases = [
  {
    ...
    beforeImage: '/assets/cases/10.jpg',
    afterImage: '/assets/cases/10.jpg',
    highlight: '个性化定制，适配度提升90%',
    // 相关图片
    relatedImgs: [
      '/assets/cases/10.jpg',
      '/assets/cases/10-1.jpg'
  ...
  },
  {
    ...
    beforeImage: '/assets/cases/1.jpg', 
    afterImage: '/assets/cases/1.jpg',
    highlight: '减重30%，制造成本降低25%',
    // 相关图片
    relatedImgs: [
      '/assets/cases/1-1.jpg',
      '/assets/cases/1-2.jpg',
      '/assets/cases/1-3.jpg',
    ]
  },
  {
    id: 3,
    ...
    beforeImage: '/assets/cases/2.jpg',
    afterImage: '/assets/cases/2.jpg',
    highlight: '开发周期缩短40%',
    relatedImgs: [
      '/assets/cases/2-1.jpg',
      '/assets/cases/2-2.jpg'
  ...
  },
  {
    ...
    beforeImage: '/assets/cases/3.jpg',
    afterImage: '/assets/cases/3.jpg',
    relatedImgs: [
      '/assets/cases/3-1.jpg',
      '/assets/cases/3-2.jpg',
      '/assets/cases/3-3.jpg',
    ],
    ...
    cases: [
      {
        ...
        image: '/assets/cases/solution-1.jpg',
      },
      {
        id: 102,
        title: '手术导板打印案例',
        description: '术前规划用3D打印导板，提高手术精准度和成功率。',
        image: '/assets/cases/solution-2.jpg',
      },
      {
        id: 103,
        title: '牙科应用案例',
        description: '定制化假牙、正畸托槽等牙科产品的3D打印解决方案。',
        image: '/assets/cases/solution-3.jpg',
      },
    ],
    ...
    cases: [
      {
        ...
        image: '/assets/cases/solution-4.jpg',
      },
      {
        id: 202,
        title: '无人机部件案例',
        description: '为无人机制造商提供定制化3D打印结构件，提高飞行性能。',
        image: '/assets/cases/solution-5.jpg',
      },
      {
        id: 203,
        title: '航天器原型件案例',
        description: '太空探索用零部件的3D打印原型与小批量生产。',
        image: '/assets/cases/solution-6.jpg',
      },
    ],
    ...
    cases: [
      {
        ...
        image: '/assets/cases/solution-7.jpg',
      },
      {
        id: 302,
        title: '定制化汽车配件',
        description: '为高端汽车提供定制化3D打印内饰和功能部件。',
        image: '/assets/cases/solution-8.jpg',
      },
      {
        id: 303,
        title: '工装夹具案例',
        description: '生产线上的3D打印工装夹具，提高生产效率和灵活性。',
        image: '/assets/cases/solution-9.jpg',
      },
    ],
    ...
    cases: [
      {
        ...
        image: '/assets/cases/solution-10.jpg',
      },
      {
        id: 402,
        title: '科研设备部件',
        description: '高校实验室用定制化3D打印科研设备配件。',
        image: '/assets/cases/solution-11.jpg',
      },
      {
        id: 403,
        title: '学生项目支持',
        description: '为学生创新项目提供3D打印技术支持和材料。',
        image: '/assets/cases/solution-12.jpg',
      },
    ],
