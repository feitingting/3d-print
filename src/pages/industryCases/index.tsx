...
const featuredCases = [
  {
    ...
    beforeImage: 'http://maphium.com/assets/cases/10.png',
    afterImage: 'http://maphium.com/assets/cases/10.png',
    highlight: '个性化定制，适配度提升90%',
    // 相关图片
    relatedImgs: [
      'http://maphium.com/assets/cases/10.png',
      'http://maphium.com/assets/cases/10-1.jpg'
      // require('http://maphium.com/assets/cases/10-2.jpg'),
    ]
  },
  {
    id: 2,
    ...
    beforeImage: 'http://maphium.com/assets/cases/1.png', 
    afterImage: 'http://maphium.com/assets/cases/1.png',
    highlight: '减重30%，制造成本降低25%',
    // 相关图片
    relatedImgs: [
      'http://maphium.com/assets/cases/1-1.jpg',
      'http://maphium.com/assets/cases/1-2.jpg',
      'http://maphium.com/assets/cases/1-3.jpg',
    ]
  },
  {
    id: 3,
    ...
    beforeImage: 'http://maphium.com/assets/cases/2.png',
    afterImage: 'http://maphium.com/assets/cases/2.png',
    highlight: '开发周期缩短40%',
    relatedImgs: [
      'http://maphium.com/assets/cases/2-1.jpg',
      'http://maphium.com/assets/cases/2-2.jpg'
      // require('http://maphium.com/assets/cases/1-3.jpg'),
      // require('http://maphium.com/assets/cases/3.jpg'),
    ]
  },
  {
    id: 4,
    ...
    beforeImage: 'http://maphium.com/assets/cases/3.png',
    afterImage: 'http://maphium.com/assets/cases/3.png',
    relatedImgs: [
      'http://maphium.com/assets/cases/3-1.jpg',
      'http://maphium.com/assets/cases/3-2.png',
      'http://maphium.com/assets/cases/3-3.png',
    ],
    ...
    cases: [
      {
        ...
        image: 'http://maphium.com/assets/cases/solution-1.png',
      },
      {
        id: 102,
        title: '手术导板打印案例',
        description: '术前规划用3D打印导板，提高手术精准度和成功率。',
        image: 'http://maphium.com/assets/cases/solution-2.png',
      },
      {
        id: 103,
        title: '牙科应用案例',
        description: '定制化假牙、正畸托槽等牙科产品的3D打印解决方案。',
        image: 'http://maphium.com/assets/cases/solution-3.png',
      },
    ],
    ...
    cases: [
      {
        ...
        image: 'http://maphium.com/assets/cases/solution-4.png',
      },
      {
        id: 202,
        title: '无人机部件案例',
        description: '为无人机制造商提供定制化3D打印结构件，提高飞行性能。',
        image: 'http://maphium.com/assets/cases/solution-5.png',
      },
      {
        id: 203,
        title: '航天器原型件案例',
        description: '太空探索用零部件的3D打印原型与小批量生产。',
        image: 'http://maphium.com/assets/cases/solution-6.png',
      },
    ],
    ...
    cases: [
      {
        ...
        image: 'http://maphium.com/assets/cases/solution-7.png',
      },
      {
        id: 302,
        title: '定制化汽车配件',
        description: '为高端汽车提供定制化3D打印内饰和功能部件。',
        image: 'http://maphium.com/assets/cases/solution-8.png',
      },
      {
        id: 303,
        title: '工装夹具案例',
        description: '生产线上的3D打印工装夹具，提高生产效率和灵活性。',
        image: 'http://maphium.com/assets/cases/solution-9.png',
      },
    ],
    ...
    cases: [
      {
        ...
        image: 'http://maphium.com/assets/cases/solution-10.png',
      },
      {
        id: 402,
        title: '科研设备部件',
        description: '高校实验室用定制化3D打印科研设备配件。',
        image: 'http://maphium.com/assets/cases/solution-11.png',
      },
      {
        id: 403,
        title: '学生项目支持',
        description: '为学生创新项目提供3D打印技术支持和材料。',
        image: 'http://maphium.com/assets/cases/solution-12.png',
      },
    ],
...
const customerReviews = [
  {
    id: 1,
    company: '某知名医疗设备公司',
    logo: 'http://maphium.com/assets/cases/avatar1.png',
  ...
  },
  {
    id: 2,
    company: '某航空公司',
    logo: 'http://maphium.com/assets/cases/avatar2.png',
  ...
  },
  {
    id: 3,
    company: '某汽车制造商',
    logo: 'http://maphium.com/assets/cases/avatar3.png',
